import { ArrowLeft, ChevronRight, LogOut, User, Clock, Heart, CreditCard, HelpCircle } from "lucide-react";
...
const Profile = () => {
  ...
  return (
    <div className="px-5 pt-12">
      ...
      {/* User Card */}
      <div className="bg-card rounded-lg p-4 border border-border flex items-center gap-4 mb-8">
      ...
      {/* Recent Orders */}
      <h2 className="font-heading text-base font-bold mb-4">Recent Orders</h2>
